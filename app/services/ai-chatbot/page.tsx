...
const service = {
  ...
  longDescription:
    'Stop losing potential customers after hours. Our AI chatbots engage visitors instantly, answer their questions, capture their details, and book appointments — all without human intervention. Trained on your business data, they sound natural and convert like your best salesperson.',
  icon: '🤖',
  accentColor: '#00df89',
...
const offerings = [
  { title: '24/7 Website Chatbot', desc: 'Round-the-clock AI assistant that greets visitors and handles enquiries instantly.' },
  { title: 'FAQ Answering', desc: 'Train your chatbot on your FAQs so it answers accurately and frees up your team.' },
  { title: 'Lead Collection', desc: 'Capture names, emails, and phone numbers from interested visitors automatically.' },
  { title: 'Appointment Booking', desc: 'Let prospects book calls or appointments directly through the chat interface.' },
];
...
const targets = [
  ...
  { name: 'Home Service Companies', icon: '🛠️' },
];

const skills = ['AI/ML', 'Natural Language Processing', 'Web Integration'];

const pricingPlans = [
  { name: 'Starter', price: '£500', monthly: '£100', desc: 'Perfect for small businesses testing AI chatbots.', features: ['Single website chatbot', 'FAQ answering', 'Lead collection forms', 'Basic NLP training', 'Email support'] },
  { name: 'Pro', price: '£1,000', monthly: '£250', desc: 'Full-featured chatbot with appointment booking.', features: ['Advanced NLP responses', 'Appointment booking', 'Multi-language support', 'Live chat handoff', 'Analytics dashboard', 'Priority support'] },
  { name: 'Enterprise', price: '£1,500', monthly: '£500', desc: 'Custom AI chatbot with deep integrations.', features: ['Custom AI training', 'CRM integration', 'Payment collection', 'Multi-website deployment', 'Dedicated account manager', '99.9% uptime SLA'] },
];

const faqs = [
  { q: 'How long does it take to set up an AI chatbot?', a: 'A basic chatbot can be deployed in under a week. More advanced chatbots with custom training and integrations typically take 2-3 weeks.' },
  { q: 'Will the chatbot sound like my brand?', a: 'Yes. We train the chatbot on your business data, FAQs, and tone of voice so it feels like a natural extension of your team.' },
  { q: 'Can the chatbot book appointments automatically?', a: 'Absolutely. It can check availability, schedule appointments, and send calendar invites — all through natural conversation.' },
  { q: 'What platforms does the chatbot work on?', a: 'We integrate with your website, and can also deploy on Facebook Messenger, WhatsApp, and other messaging platforms.' },
];
          ...
          <div className="bg-white rounded-[2.5rem] p-8 sm:p-12 md:p-16 text-black shadow-2xl flex flex-col lg:flex-row justify-between items-center gap-10 relative overflow-hidden">
            ...
            <div className="flex-1 text-left relative z-10">
              ...
              <p className="text-slate-600 mt-4 text-sm sm:text-base max-w-xl">
                Start capturing leads while you sleep. Get a free consultation and custom quote today.
              </p>
            </div>
            <div className="shrink-0 relative z-10">
              <Link
                href="mailto:hello@crafix.tech?subject=AI Chatbot Enquiry"
