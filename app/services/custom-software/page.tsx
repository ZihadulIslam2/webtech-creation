...
const service = {
  ...
  description:
    'We build custom CRM systems, inventory platforms, booking portals, and internal business tools tailored to your exact requirements. Off-the-shelf software rarely fits perfectly — we build solutions that match your workflows.',
  icon: '⚙️',
};

const offerings = [
  { title: 'CRM Systems', desc: 'Custom CRM platforms built around your sales pipeline, customer data, and team workflows.' },
  { title: 'Inventory Systems', desc: 'Real-time inventory management with stock tracking, order management, and supplier integration.' },
  { title: 'Booking Platforms', desc: 'Scheduling and reservation systems with payment processing, availability management, and automated reminders.' },
  { title: 'Internal Business Tools', desc: 'Bespoke internal applications for process automation, team collaboration, and data management.' },
];

const targets = [
  { name: 'Growing Businesses', icon: '📈' },
  { name: 'Enterprises', icon: '🏢' },
  { name: 'Startups', icon: '🚀' },
  { name: 'Agencies', icon: '🏪' },
];

const skills = ['MERN Stack', 'React', 'Node.js', 'MongoDB', 'PostgreSQL'];

const pricingPlans = [
  { name: 'Starter', price: '£2,000–£5,000', period: 'project', desc: 'For smaller tools and MVPs with core functionality.', features: ['Requirement analysis', 'Core feature development', 'Database design', 'Basic UI/UX', '1 month support'] },
  { name: 'Business', price: '£5,000–£10,000', period: 'project', desc: 'Full-featured applications for growing businesses.', features: ['Full requirement spec', 'Advanced feature set', 'API integrations', 'Custom UI/UX design', '3 months support', 'Deployment & hosting'] },
  { name: 'Enterprise', price: '£10,000–£20,000+', period: 'project', desc: 'Large-scale platforms with complex architecture.', features: ['Enterprise architecture', 'Multi-user role system', 'Third-party integrations', 'Advanced security audit', '6 months support', 'Ongoing maintenance'] },
];

const faqs = [
  { q: 'How long does custom software development take?', a: 'Timelines vary by complexity. A typical MVP takes 4-8 weeks, while full enterprise platforms can take 3-6 months or more.' },
  { q: 'Do you provide ongoing support after launch?', a: 'Yes. We offer maintenance and support packages to handle updates, bug fixes, and feature additions after your project goes live.' },
  { q: 'Can you integrate with my existing tools?', a: 'Absolutely. We build integrations with popular third-party services including CRMs, accounting software, payment gateways, and APIs.' },
  { q: 'What if my requirements change during development?', a: 'We use agile methodology with regular check-ins, so we can adapt to changing requirements without disrupting the project timeline.' },
];
    ...
    <main className="bg-black min-h-screen text-white">
      ...
      <section className="relative py-16 md:py-20 bg-[#020d0e] overflow-hidden border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
          <p className="text-xs font-bold uppercase tracking-[0.25em] text-[#00df89] mb-8">Tech Stack</p>
          ...
          <div className="bg-white rounded-[2.5rem] p-8 sm:p-12 md:p-16 text-black shadow-2xl flex flex-col lg:flex-row justify-between items-center gap-10 relative overflow-hidden">
            ...
            <div className="flex-1 text-left relative z-10">
              ...
              <p className="text-slate-600 mt-4 text-sm sm:text-base max-w-xl">
                Let us discuss your requirements and build software that fits your business perfectly.
              </p>
            </div>
            <div className="shrink-0 relative z-10">
              <Link
                href="mailto:hello@Webtech.com?subject=Custom Software Development Enquiry"
