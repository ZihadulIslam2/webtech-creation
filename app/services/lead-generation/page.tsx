...
const offerings = [
  { title: 'Generate Leads', desc: 'Multi-channel lead generation campaigns that attract and capture high-quality prospects for your business.' },
  { title: 'Contact Form Leads', desc: 'Optimised contact forms and lead capture systems that convert website visitors into actionable inquiries.' },
  { title: 'Appointment Leads', desc: 'Schedule-ready leads with automated booking integration so you spend less time chasing and more time closing.' },
  { title: 'Lead Nurturing', desc: 'Automated email and SMS sequences that warm up cold leads and guide them through your sales funnel.' },
];

const targets = [
  { name: 'Realtors', icon: '🏠' },
  { name: 'Mortgage Brokers', icon: '💰' },
  { name: 'Insurance Agents', icon: '🛡️' },
  { name: 'Home Service Pros', icon: '🔧' },
];

const skills = ['Marketing Automation', 'CRM', 'Landing Page Design', 'Analytics'];

const pricingPlans = [
  { name: 'Starter', price: '£500', period: '/month', desc: 'For small businesses starting to build a sales pipeline.', features: ['Lead capture setup', '1 landing page', 'Contact form integration', 'Basic CRM setup', 'Monthly lead report'] },
  { name: 'Pro', price: '£1,000', period: '/month', desc: 'For growing teams that need consistent lead flow.', features: ['Multi-channel lead gen', '3 landing pages', 'CRM automation', 'Email nurture sequences', 'Appointment scheduling', 'Weekly lead delivery'] },
  { name: 'Enterprise', price: '£2,000', period: '/month', desc: 'Full-scale lead generation for high-volume sales teams.', features: ['Unlimited lead campaigns', 'Custom landing pages', 'Advanced CRM workflows', 'Multi-channel outreach', 'Dedicated lead manager', 'Real-time analytics dashboard'] },
];

const faqs = [
  { q: 'What kind of leads can you generate?', a: 'We generate qualified leads based on your ideal customer profile using targeted landing pages, forms, and outreach campaigns across multiple channels.' },
  { q: 'How long does it take to start seeing leads?', a: 'Most clients see their first leads within 1-2 weeks of launch. Full optimisation and consistent lead flow typically takes 4-6 weeks.' },
  { q: 'Do I need an existing website?', a: 'No. We build dedicated landing pages and lead capture systems that work independently or integrate with your existing site.' },
  { q: 'How do you qualify leads before sending them?', a: 'We use automated qualification questions and scoring criteria to ensure every lead meets your minimum requirements before delivery.' },
];
          ...
          <div className="bg-white rounded-[2.5rem] p-8 sm:p-12 md:p-16 text-black shadow-2xl flex flex-col lg:flex-row justify-between items-center gap-10 relative overflow-hidden">
            ...
            <div className="flex-1 text-left relative z-10">
              ...
              <p className="text-slate-600 mt-4 text-sm sm:text-base max-w-xl">
                Let us build a lead generation system that delivers qualified prospects straight to your inbox.
              </p>
            </div>
            <div className="shrink-0 relative z-10">
              <Link
                href="mailto:hello@crafix.tech?subject=Lead Generation Enquiry"
